  ...
  return (
    <>
      <div className="w-full max-w-xs">
        ...
        <form
          className="shadow-md rounded px-8 pt-6 pb-8 mb-4 Itext-black border-gray-400"
  ...
  return new Promise<void>((resolve, reject) => {
    setTimeout(() => {
      ...
      if (shouldError) {
        reject(
          new Error(
            "Tebakan yang bagus tetapi jawaban salah. Silahkan coba lagi!"
          )
        );
      } else {
        resolve();
  ...
  return (
    <>
      ...
      <label className="block w-full m-2">
        Nama depan:
        <input
          className="text-sm value={firstName} Itext-black ml-2 rounded"
          value={firstName}
      ...
      <label className="block w-full m-2">
        Nama belakang:
        <input
          className="text-sm value={lastName} Itext-black ml-2 rounded"
          value={lastName}
